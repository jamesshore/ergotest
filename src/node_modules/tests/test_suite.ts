...
interface Describe {
	(optionalName: string | DescribeFunction, describeFn?: DescribeFunction): void,
	skip: (optionalName: string | DescribeFunction, descrbeFn?: DescribeFunction) => void,
	only: (optionalName: string | DescribeFunction, describeFn?: DescribeFunction) => void,
}
