...
export default class Reporter {
	 ...
	 */
	static create(debug = false, stdout = ConsoleOutput.createStdout()) {
...
class Report {
	 ...
	 */
	progress(text = DEFAULT_PROGRESS_TEXT, {
		debug = "",
	} = {}) {
	...
	/**
	 * Write text that will only be shown if the reporter was in debug mode.
	 * @param {string} text The text to write
	 */
	debug(text) {
