...
export default test(({ describe }) => {
	...
	describe("running tasks", ({ it }) => {
		...
		it("runs build and provides tasks specified on command line", async () => {
...
async function runAsync({
	...
	let buildParms;
	const returnValue = await cli.runAsync(tasks, successMessage, failureMessage, async (taskNames) => {
		buildParms = { taskNames };
		await buildFnAsync();
	});
