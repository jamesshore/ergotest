...
const TestSuite = require("./test_suite.cjs");
const TestResult = require("./test_result.cjs");
const Clock = require("infrastructure/clock.js");
const child_process = require("node:child_process");
const path = require("node:path");
// dependency: ./test_runner_child_process.js

const WORKER_FILENAME = path.resolve(__dirname, "./test_runner_child_process.cjs");
