...
/** System clock. */ export class Clock {
	 ...
	 */ static create() {
        ...
        return new Clock({
            ...
            clearInterval,
            tickAsync () {
                throw new Error("Can't advance the clock because it isn't a null clock");
            },
	 ...
	 */ async timeoutAsync(milliseconds, fnAsync, timeoutFnAsync) {
        ...
        return await new Promise((resolve, reject)=>{
            ...
            Promise.resolve(fnAsync()).then(resolve).catch(reject).finally(()=>this._globals.clearTimeout(timeoutToken));
        });
    }
    /**
