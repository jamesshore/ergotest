...
export default test(({ beforeEach, it })=>{
    ...
    it("runs test modules", async ()=>{
        ...
        const results = await runner.runIsolatedAsync([
            TEST_MODULE_PATH
        ]);
    ...
    it("handles infinite loops", async ()=>{
        ...
        const resultsPromise = runner.runIsolatedAsync([
            TEST_MODULE_PATH
        ]);
...
//# sourceMappingURL=/Users/jshore/Documents/Projects/ergotest/generated/src/tests/_test_runner_test.js.map
